...
public class TransferwiseSynchronizeJobProviderKontoauszug implements TransferwiseSynchronizeJobProvider
{
  @Resource
  private TransferwiseSynchronizeBackend backend = null;
  
  private final static List<Class<? extends SynchronizeJob>> JOBS = new ArrayList<Class<? extends SynchronizeJob>>()
  {{
    add(TransferwiseSynchronizeJobKontoauszug.class);
  }};
